...
{"clap","ปีน","ต่อสู้","ปรบมือ"," แปรงฟัน"},
{"crawl","นับ","คลาน"," เป่า","หัวเราะ"},
...
{"wash the dish","สัญญา","ว่ายน้ำ","ล้างจาน","วาดรูป"}
    ...
    int [] ans = new int[]{1,2,2,1,1,4,3,3,3,3};
    public Verb() {
        initComponents();
         this.nextCount();
    }
 private void nextCount(){
        ...
        wordGame.setText(verbs[count][0]);
        wordCount.setText(Integer.toString(count+1));
        scoreNumber.setText(Integer.toString(score));
        option1.setText(verbs[count][1]);
        option2.setText(verbs[count][2]);
        option3.setText(verbs[count][3]);
        option4.setText(verbs[count][4]);
        }else{
            stage="Ended";
          scoreNumber.setText(Integer.toString(score));
    ...
    private void initComponents() {
        ...
        wordGame.setText("\tRead");
        bg.add(wordGame, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 130, -1, -1));
