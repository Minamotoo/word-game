...
{"Laundry","ร้านกาแฟ","ที่ทำการไปรษณีย์"," ซักรีด"," โรงหนัง"},
...
{"Police Station","ร้านกาแฟ","ที่ทำการไปรษณีย์"," สถานีตำรวจ"," โรงหนัง"}
    ...
    int [] ans = new int[]{3,1,1,2,3,2,4,3,4,3};
    public Places() {
        initComponents();
        this.nextCount();
    }
private void nextCount(){
        ...
        wordGame.setText(places[count][0]);
        wordCount.setText(Integer.toString(count+1));
        scoreNumber.setText(Integer.toString(score));
        option1.setText(places[count][1]);
        option2.setText(places[count][2]);
        option3.setText(places[count][3]);
        option4.setText(places[count][4]);
        }else{
            stage="Ended";
          scoreNumber.setText(Integer.toString(score));
    ...
    private void initComponents() {
        ...
        wordGame.setText("Airport");
        bg.add(wordGame, new org.netbeans.lib.awtextra.AbsoluteConstraints(8, 130, 390, -1));
